...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used to specify custom validation messages
    | for attributes using the convention "attribute.rule" to name the lines.
     */

    'success' => 'Operación exitosa.',
    'error' => 'Operación fallida.',
    'not_found' => 'Recurso no encontrado.',
    'no_permissions' => 'No estás autorizado para acceder a este recurso.',
    'validation_error' => 'Error de validación.',
    'no_fields_sent' => 'No se enviaron campos.',
